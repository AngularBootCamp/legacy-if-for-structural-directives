# Angular Boot Camp example: legacy-if-for-structural-directives
...
**[StackBlitz for legacy-if-for-structural-directives](https://stackblitz.io/github/AngularBootCamp/legacy-if-for-structural-directives)**

Alternatively, you can clone the repository locally to run the example:

```
git clone git@github.com:AngularBootCamp/legacy-if-for-structural-directives.git
cd legacy-if-for-structural-directives
npm install
npm start
```
